...
createRandomCrewman = [_path, "createUnits\createRandomCrewman.sqf"] call mf_compile;
...
createRandomSoldierSoul = [_path, "createRandomSoldierSoul.sqf"] call mf_compile;
...
randomCrateLoadOutNoThermal = [_path, "randomCrateLoadOutNoThermal.sqf"] call mf_compile;
